...
$perpustakaan = mysqli_query($conn, "SELECT * FROM petugas");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Halaman Index Petugas</title>
    ...
    <table>
        ...
        <?php foreach ($perpustakaan as $perpus) { ?>
            <tr>
                ...
                <td><?= $perpus['alamat'] ?></td>
                <td>
                    <a href="ubahPetugas.php?id_petugas=<?= $perpus['id_petugas'] ?>">Ubah</a> ||
                    <a href="hapusPetugas.php?id_petugas=<?= $perpus['id_petugas'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data Petugas ini?')">Hapus</a>
                </td>
            </tr>
        <?php } ?>
    </table>
